...
import 'piccolore';
import { c as renderComponent, d as renderTemplate, m as maybeRenderHead, e as addAttribute, f as renderSlot } from './server_Du_7o2g7.mjs';
import { b as getEntry, r as renderEntry, g as getCollection } from './_astro_content_C_UNwJv_.mjs';
import { $ as $$Layout, a as $$Breadcrumb } from './Layout_DggAW1u-.mjs';
...
const $$LayoutBlog = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": title, "metaTitle": metaTitle, "metaDescription": metaDescription || excerpt || "", "ogImage": ogImage || featuredImagePath, "ogType": "article", "publishDate": new Date(publishDate), "lang": lang, "jsonType": "blog", "alternateUrls": alternateUrls, "data-astro-cid-m337sa5b": true }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<article class="bg-[#fdfdfd] min-h-screen pb-10" data-astro-cid-m337sa5b> <div class="min-h-[82vh] md:min-h-[93vh] flex flex-col items-center justify-center" data-astro-cid-m337sa5b> <header class="relative pb-8  md:py-8" data-astro-cid-m337sa5b> <div class="max-w-4xl mx-auto px-6 text-center" data-astro-cid-m337sa5b> <div class="inline-block px-6 pt-0 mt-8 md:mt-0 pb-1 rounded-lg bg-limolo-green/5 border border-limolo-green/10 mb-4" data-astro-cid-m337sa5b> <span class="text-[10px] uppercase tracking-[0.3em]  font-bold text-limolo-green" data-astro-cid-m337sa5b> ${categoryLabel} </span> </div> <h1 class="text-3xl md:text-4xl font-serif text-limolo-green leading-[1.1] mb-4" data-astro-cid-m337sa5b> ${cleanText(displayH1)} </h1> <div class="flex items-center justify-center gap-4 text-gray-400" data-astro-cid-m337sa5b> <span class="h-px w-8 bg-gray-200" data-astro-cid-m337sa5b></span> <time class="text-[11px] uppercase tracking-widest font-bold" data-astro-cid-m337sa5b> ${formatDate(publishDate, lang)} </time> <span class="h-px w-8 bg-gray-200" data-astro-cid-m337sa5b></span> </div> ${excerpt && renderTemplate`<p class="py-4 text-xl md:text-2xl text-gray-600 font-serif italic leading-relaxed max-w-3xl mx-auto" data-astro-cid-m337sa5b>
"${cleanText(excerpt)}"
</p>`} </div> </header> ${featuredImagePath && renderTemplate`<div class="w-full max-w-xl mx-auto px-4 mb-20" data-astro-cid-m337sa5b> <div class="relative aspect-square md:aspect-21/11 rounded-xl overflow-hidden shadow-2xl shadow-limolo-green/10" data-astro-cid-m337sa5b> <img${addAttribute(featuredImagePath, "src")}${addAttribute(featuredImageAlt || title, "alt")} class="w-full h-full object-cover" data-astro-cid-m337sa5b> </div> </div>`} </div> <div class="prose-content max-w-4xl mx-auto" data-astro-cid-m337sa5b> ${renderSlot($$result2, $$slots["default"])} </div> ${related && related.length > 0 && renderTemplate`<section class="bg-gray-50 border-t border-gray-100 mt-24 py-24" data-astro-cid-m337sa5b> <div class="max-w-7xl mx-auto px-6" data-astro-cid-m337sa5b> <h2 class="text-3xl font-serif text-limolo-green text-center mb-16" data-astro-cid-m337sa5b> ${getRelatedTitle(lang)} </h2> <div class="grid grid-cols-1 md:grid-cols-3 gap-10" data-astro-cid-m337sa5b> ${await Promise.all(
