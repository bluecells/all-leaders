...
import 'piccolore';
import { m as maybeRenderHead, e as addAttribute, d as renderTemplate, u as unescapeHTML, c as renderComponent } from './server_hrxctkJq.mjs';
import { r as renderScript, $ as $$Layout } from './Layout_BdTiism6.mjs';
import 'clsx';
...
<strong data-astro-cid-j7pv25f6>Ces frontières invisibles freinent votre épanouissement et la dynamique collective.</strong> </p> <nav aria-label="Navigation principale" data-astro-cid-j7pv25f6> <a href="/contact" class="mt-8 btn btn-secondary" data-astro-cid-j7pv25f6>Il est temps de les <strong data-astro-cid-j7pv25f6>dépasser</strong></a> </nav> </div> <main data-astro-cid-j7pv25f6> <!-- ==========================================
...
${renderComponent($$result2, "Grid", $$Grid, { "textColor": "var(--color-text-primary)", "items": [
  ...
  ], "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "CompassLinks", $$CompassLinks, { "data-astro-cid-j7pv25f6": true })} <!-- Placeholder pour les modules/offres détaillées --> <div id="offre-modules" aria-label="Nos modules d'intervention" data-astro-cid-j7pv25f6> <!-- Insérer ici les cards d'offres --> </div> </div> </section> <!-- ==========================================
