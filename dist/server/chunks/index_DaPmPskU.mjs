...
import 'piccolore';
import { m as maybeRenderHead, e as addAttribute, d as renderTemplate, u as unescapeHTML, c as renderComponent } from './server__edj_reH.mjs';
import { r as renderScript, $ as $$Layout } from './Layout_D4dKH1zz.mjs';
import 'clsx';
...
const $$CompassLinks = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="compass-main" data-astro-cid-denskwaw> <h3 class="text-center! w-full mx-auto max-w-4xl! pt-8" data-astro-cid-denskwaw>
Transformer les <strong data-astro-cid-denskwaw>intentions en actions</strong> concrètes, pour des équipes agissant avec <strong data-astro-cid-denskwaw>sens, clarté et impact</strong>.
</h3> <div class="compass-container" data-astro-cid-denskwaw> <div class="compass-perspective-wrapper" data-astro-cid-denskwaw> <!-- L'image de fond est maintenant gérée comme un carré indépendant --> <div class="compass-rose-bg" id="compassRoseBg" data-astro-cid-denskwaw></div> <div class="compass-compass-fixed" data-astro-cid-denskwaw></div> <div class="compass-orbit" id="compassOrbit" data-astro-cid-denskwaw> <a href="/accompagnements#gestionConflits" class="compass-link" data-index="0" data-astro-cid-denskwaw> <span data-astro-cid-denskwaw>Gestion de la<br data-astro-cid-denskwaw>conflictualité</span> </a> <a href="/accompagnements#diagPerf" class="compass-link" data-index="1" data-astro-cid-denskwaw> <span data-astro-cid-denskwaw>Diagnostic de la<br data-astro-cid-denskwaw>performance</span> </a> <a href="/accompagnements#coaching" class="compass-link" data-index="2" data-astro-cid-denskwaw> <span data-astro-cid-denskwaw>Coaching de<br data-astro-cid-denskwaw>managers</span> </a> <a href="/accompagnements#sante" class="compass-link" data-index="3" data-astro-cid-denskwaw> <span data-astro-cid-denskwaw>Santé mentale et<br data-astro-cid-denskwaw>performance durable</span> </a> <a href="/accompagnements#leadership" class="compass-link" data-index="4" data-astro-cid-denskwaw> <span data-astro-cid-denskwaw>Développement<br data-astro-cid-denskwaw>Leadership</span> </a> </div> </div> </div> </div> ${renderScript($$result, "/Users/bluecells/Websites/all-leaders/src/components/UI/CompassLinks.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/bluecells/Websites/all-leaders/src/components/UI/CompassLinks.astro", void 0);

const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderScript($$result, "/Users/bluecells/Websites/all-leaders/src/pages/index.astro?astro&type=script&index=0&lang.ts")} ${renderComponent($$result, "Layout", $$Layout, { "title": "All Leaders Initiative — Leadership basé sur l'intention pour dirigeants et équipes managériales", "lang": "fr", "metaTitle": "All Leaders Initiative — Conseil en Leadership et Performance Collective", "metaDescription": "All Leaders Initiative accompagne les équipes managériales, comités de direction et dirigeants pour dépasser les blocages collectifs et développer un leadership basé sur l'intention.", "data-astro-cid-j7pv25f6": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="mx-auto px-4 py-12 hero-section" data-astro-cid-j7pv25f6> <!-- Hero Title - Animé après --> <div class="hero-title" data-astro-cid-j7pv25f6> <img class="w-full h-50 text-center" src="/images/pages/logo-all-leaders-rond-fonce.svg" data-astro-cid-j7pv25f6> <h1 class="mb-0! pb-0! text-6xl! font-sans uppercase" style="opacity: 0;" data-astro-cid-j7pv25f6>
All Le<span style="color: var(--color-brand-secondary);" data-astro-cid-j7pv25f6>a</span>ders <span style="font-weight: 300;" data-astro-cid-j7pv25f6>Initiative</span> </h1> <h2 class="mt-4! pb-0! text-3xl! leading-9!" data-astro-cid-j7pv25f6>
Conseil en performance collective pour dirigeants et équipes managériales.
</h2> </div> <!-- Hero Quote - Centre au début, puis slide vers le bas --> <div class="hero-quote-wrapper" data-astro-cid-j7pv25f6> <p class="hero-quote pb-0! max-w-5xl mx-auto" data-astro-cid-j7pv25f6> <q data-astro-cid-j7pv25f6>&nbsp;Toutes les équipes performantes se ressemblent.<br data-astro-cid-j7pv25f6>
Mais chaque équipe dysfonctionnelle l'est à sa façon.&nbsp;</q> </p> <p class="hero-quote hero-question text-6xl! not-italic! pt-10!" data-astro-cid-j7pv25f6> <span class="question-dash" data-astro-cid-j7pv25f6>&mdash; Et </span><span class="question-word" data-astro-cid-j7pv25f6>la vôtre&nbsp;?</span> </p> </div> </div> <div class="max-w-3xl mx-auto text-center" style="height:60vh;" data-astro-cid-j7pv25f6> <h2 id="h2-pourquoi" data-astro-cid-j7pv25f6>
Dépasser les <strong data-astro-cid-j7pv25f6>barrières invisibles</strong> de votre équipe
...
Vous sentez qu'il serait possible de <strong data-astro-cid-j7pv25f6>mieux collaborer</strong>, de retrouver du <strong data-astro-cid-j7pv25f6>sens</strong>, de <strong data-astro-cid-j7pv25f6>fluidifier les relations</strong>… mais quelque chose bloque. Des habitudes
      ancrées, des non-dits, un manque de clarté.
<strong data-astro-cid-j7pv25f6>Ces frontières invisibles freinent votre épanouissement et la dynamique collective.</strong> </p> <nav aria-label="Navigation principale" data-astro-cid-j7pv25f6> <a href="/contact" class="mt-8 btn btn-secondary" data-astro-cid-j7pv25f6>Il est temps <strong data-astro-cid-j7pv25f6>d'agir</strong></a> </nav> </div> <main data-astro-cid-j7pv25f6> <!-- ==========================================
         SECTION 1 — Pourquoi All Leaders Initiative
    =========================================== --> <section id="notre-approche" aria-labelledby="h2-pourquoi" data-astro-cid-j7pv25f6> <div class="container h-[50dvh]" data-astro-cid-j7pv25f6> <h2 id="h2-fondateurs" class="text-center! mt-8" data-astro-cid-j7pv25f6> <strong data-astro-cid-j7pv25f6>Deux fondateurs</strong>, une vision commune du <strong data-astro-cid-j7pv25f6>leadership basé sur l'intention</strong> </h2> <p class="text-center" data-astro-cid-j7pv25f6>
Nous avons créé All Leaders Initiative pour vous permettre de questionner ce qui ne
          fonctionne plus, oser de nouvelles façons d'agir et vous affranchir de ces barrières
          invisibles. <strong data-astro-cid-j7pv25f6>Pour réussir, ensemble</strong>.
</p> </div> <div class="container h-[80dvh]" data-astro-cid-j7pv25f6> <div class="values-section" data-astro-cid-j7pv25f6>  <div class="values-image-left hidden md:flex" data-astro-cid-j7pv25f6> <img src="/images/pages/marie-emmanuelle-py-acquarelle.webp" alt="Marie-Emmanuelle Py" class="w-full h-auto object-cover rounded-lg" data-astro-cid-j7pv25f6> <h3 itemprop="name" data-astro-cid-j7pv25f6>Marie Emmanuelle PY</h3> <p class="mb-4" itemprop="jobTitle" data-astro-cid-j7pv25f6>Associée fondatrice</p> <ul class="contact-list" data-astro-cid-j7pv25f6> <li data-astro-cid-j7pv25f6> <a href="mailto:me@all-leaders.fr" itemprop="email" aria-label="Envoyer un email à Marie Emmanuelle Py" data-astro-cid-j7pv25f6>
me@all-leaders.fr
...
Profil complet
</a> </li> </ul> </div> <div class="values-grid" role="list" data-astro-cid-j7pv25f6> <article role="listitem" data-astro-cid-j7pv25f6> <h3 class="font-semibold text-2xl pt-4" data-astro-cid-j7pv25f6>Nous aimons l'entreprise</h3> <p class="text-center" data-astro-cid-j7pv25f6>
...
</p> </article> <article role="listitem" data-astro-cid-j7pv25f6> <h3 class="font-semibold text-2xl" data-astro-cid-j7pv25f6>Nous croyons en l'humain</h3> <p class="text-center" data-astro-cid-j7pv25f6>
...
</p> <p class="text-center" data-astro-cid-j7pv25f6>
...
</p> <p class="text-center mt-4 text-5xl! font-serif" data-astro-cid-j7pv25f6>Cap&nbsp;?</p> </article> </div> <div class="values-image-right hidden md:flex" data-astro-cid-j7pv25f6> <img src="/images/pages/pierre-etienne-bost-acquarelle.webp" alt="Pierre-Etienne Bost" class="w-full h-auto object-cover rounded-lg" data-astro-cid-j7pv25f6> <h3 itemprop="name" data-astro-cid-j7pv25f6>Pierre-Etienne BOST</h3> <p class="mb-4" itemprop="jobTitle" data-astro-cid-j7pv25f6>Associé fondateur</p> <ul class="contact-list" data-astro-cid-j7pv25f6> <li data-astro-cid-j7pv25f6> <a href="mailto:pe@all-leaders.fr" itemprop="email" aria-label="Envoyer un email à Pierre-Etienne Bost" data-astro-cid-j7pv25f6>
pe@all-leaders.fr
...
Profil complet
</a> </li> </ul> </div>  <div class="md:hidden grid grid-cols-2 gap-4 mb-8" data-astro-cid-j7pv25f6> <img src="/images/pages/marie-emmanuelle-py-acquarelle.webp" alt="Marie-Emmanuelle Py" class="w-full h-auto object-cover" data-astro-cid-j7pv25f6> <img src="/images/pages/pierre-etienne-bost-acquarelle.webp" alt="Pierre-Etienne Bost" class="w-full h-auto object-cover" data-astro-cid-j7pv25f6> </div> </div> </div> </section> <!-- ==========================================
         SECTION 2 — Offre / Continuum
    =========================================== --> <section id="offre" aria-labelledby="h2-offre" data-astro-cid-j7pv25f6> <div class="container" data-astro-cid-j7pv25f6> <h2 id="h2-offre" class="pb-0!" data-astro-cid-j7pv25f6>
Conseil en <strong data-astro-cid-j7pv25f6>performance collective</strong>&nbsp;: du diagnostic à la
          transformation
</h2> <h3 class="mb-0 mt-0 texte-gradient" data-astro-cid-j7pv25f6>
Nous intervenons sur tout le <strong data-astro-cid-j7pv25f6>continuum de la performance collective</strong> </h3> ${renderComponent($$result2, "ContinuumGrid", $$ContinuumGrid, { "data-astro-cid-j7pv25f6": true })} <p class="text-center mt-0" data-astro-cid-j7pv25f6>
...
${renderComponent($$result2, "Grid", $$Grid, { "textColor": "var(--color-text-primary)", "items": [
  ...
  ], "data-astro-cid-j7pv25f6": true })} </p><div class="h-[60vh] flex flex-col items-center justify-center" data-astro-cid-j7pv25f6> <h3 data-astro-cid-j7pv25f6>
Nous avons accompagné de nombreuses équipes managériales, comités de direction et
              dirigeants exigeants actifs chez&nbsp;
</h3> ${renderComponent($$result2, "Carousel", $$Carousel, { "speed": "5000", "images": [
  ...
  ], "data-astro-cid-j7pv25f6": true })} </div> <!-- Placeholder pour les modules/offres détaillées --> <div id="offre-modules" aria-label="Nos modules d'intervention" data-astro-cid-j7pv25f6> <!-- Insérer ici les cards d'offres --> </div>  </div> ${renderComponent($$result2, "CompassLinks", $$CompassLinks, { "data-astro-cid-j7pv25f6": true })} <!-- ==========================================
         SECTION 3 — Partenaires & Écosystème
    =========================================== --> <section id="ecosysteme" aria-labelledby="h2-ecosysteme" data-astro-cid-j7pv25f6> <div class="container mx-auto" data-astro-cid-j7pv25f6> <h2 id="h2-ecosysteme" class="text-center! mt-8" data-astro-cid-j7pv25f6>
...
All Leaders Initiative est partie prenante du Bureau du Réel, un réseau
                    d'intervenants pour des formats de conférences disruptifs et centrés sur
                    l'expérience vécue.
...
Simulation en réalité virtuelle&nbsp;: application concrète du Leadership basé
                    sur l'intention, faisant collaborer à « haute intensité » un équipage
                    d'hélicoptère et un équipage de sous-marin. Cette mission révèle les failles de
                    communication et de collaboration, et permet d'expérimenter et d'ancrer de
                    nouveaux comportements ajustés.
...
Parce qu'on ne peut parler de relations sans parler de conflits, d'agressivité
                    voire de violence, nous avons intégré à notre expertise la gestion
                    professionnelle des conflits avec notre partenaire <b data-astro-cid-j7pv25f6>Jérôme Bouteiller</b>.
...
Parce que la performance dépend de l'adoption des bonnes postures, nous nous
                    associons à l'ancien dirigeant et militaire d'élite <b data-astro-cid-j7pv25f6>Olivier Crosetta</b> et son
                    cabinet Synergies &amp; Co pour décliner l'excellence opérationnelle à tous niveaux.
...
Parce qu'on ne peut parler de leadership sans alignement profond avec ses
                    talents naturels, nous avons intégré à notre expertise la cartographie des
                    points forts avec notre partenaire Pragmacie, certifié Gallup CliftonStrengths
                    (ex StrengthsFinder).
...
Parce que nous voulons proposer des expériences « out-door » sur mesure allant
                    plus loin dans les possibilités scénaristiques et l'engagement de vos équipes,
                    en toute sécurité, nous nous associons avec nos « frères d'armes » FA3R.
</p> <a href="https://www.fa3r.fr/" aria-label="En savoir plus sur FA3R" data-astro-cid-j7pv25f6>Apprendre sous stress, décider sous pression, tenir ensemble.</a> </div> </article> </li> </ul> </div> </section> </section> </main> ` })}`;
