...
import 'piccolore';
import { m as maybeRenderHead, e as addAttribute, d as renderTemplate, u as unescapeHTML, c as renderComponent } from './server_DEsIIqeN.mjs';
import { r as renderScript, $ as $$Layout } from './Layout_CKOt3rh_.mjs';
import 'clsx';
...
const $$ContinuumGridMobile = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="continuum-mobile-wrapper" role="img" aria-label="Continuum de la performance collective" data-astro-cid-b5jyzz7c> <div class="continuum-mobile-grid" data-astro-cid-b5jyzz7c> <!-- Zone rouge (gauche) --> <div class="mobile-zone zone-red" data-zone="1" data-astro-cid-b5jyzz7c> <span data-astro-cid-b5jyzz7c>Du groupe dysfonctionnel</span> </div> <!-- Zone bleue (droite) --> <div class="mobile-zone zone-blue" data-zone="2" data-astro-cid-b5jyzz7c> <span data-astro-cid-b5jyzz7c>Au collectif hautement performant</span> </div> </div> </div> ${renderScript($$result, "/Users/bluecells/Websites/all-leaders/src/components/UI/ContinuumGridMobile.astro?astro&type=script&index=0&lang.ts")}`;
...
const $$CompassLinks = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="compass-main" data-astro-cid-denskwaw> <h3 class="text-center! w-full mx-auto max-w-4xl! px-4 py-12 md:px-0 md:py-8" data-astro-cid-denskwaw>
...
</h3> <div class="compass-container" data-astro-cid-denskwaw> <div class="compass-perspective-wrapper" data-astro-cid-denskwaw> <!-- L'image de fond est maintenant gérée comme un carré indépendant --> <div class="compass-rose-bg" id="compassRoseBg" data-astro-cid-denskwaw></div> <div class="compass-compass-fixed" data-astro-cid-denskwaw></div> <div class="compass-orbit" id="compassOrbit" data-astro-cid-denskwaw> <a href="/accompagnements#category-gestion-conflictualite" class="compass-link" data-index="0" data-astro-cid-denskwaw> <span data-astro-cid-denskwaw>Gestion de la<br data-astro-cid-denskwaw>conflictualité</span> </a> <a href="/accompagnements#category-diagnostic-performance" class="compass-link" data-index="1" data-astro-cid-denskwaw> <span data-astro-cid-denskwaw>Diagnostic de la<br data-astro-cid-denskwaw>performance</span> </a> <a href="/accompagnements#category-coaching-managers" class="compass-link" data-index="2" data-astro-cid-denskwaw> <span data-astro-cid-denskwaw>Coaching de<br data-astro-cid-denskwaw>managers</span> </a> <a href="/accompagnements#sante" class="compass-link" data-index="3" data-astro-cid-denskwaw> <span data-astro-cid-denskwaw>Santé mentale et<br data-astro-cid-denskwaw>performance durable</span> </a> <a href="/accompagnements#category-coaching-leadership" class="compass-link" data-index="4" data-astro-cid-denskwaw> <span data-astro-cid-denskwaw>Développement<br data-astro-cid-denskwaw>Leadership</span> </a> </div> </div> </div> </div> ${renderScript($$result, "/Users/bluecells/Websites/all-leaders/src/components/UI/CompassLinks.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/bluecells/Websites/all-leaders/src/components/UI/CompassLinks.astro", void 0);

const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderScript($$result, "/Users/bluecells/Websites/all-leaders/src/pages/index.astro?astro&type=script&index=0&lang.ts")}${renderComponent($$result, "Layout", $$Layout, { "title": "All Leaders Initiative — Leadership basé sur l'intention pour dirigeants et équipes managériales", "lang": "fr", "metaTitle": "All Leaders Initiative — Conseil en Leadership et Performance Collective", "metaDescription": "All Leaders Initiative accompagne les équipes managériales, comités de direction et dirigeants pour dépasser les blocages collectifs et développer un leadership basé sur l'intention.", "data-astro-cid-j7pv25f6": true }, { "default": ($$result2) => renderTemplate`${maybeRenderHead()}<div class="mx-auto px-4 py-12 hero-section" data-astro-cid-j7pv25f6><!-- Hero Title - Animé après --><div class="hero-title" data-astro-cid-j7pv25f6><img class="w-full h-30 md:h-50 text-center" src="/images/pages/logo-all-leaders-rond-fonce.svg" data-astro-cid-j7pv25f6><h1 class="mb-0! pb-0! text-5xl! md:text-6xl! font-sans uppercase" style="opacity: 0;" data-astro-cid-j7pv25f6>
All Le<span style="color: var(--color-brand-secondary);" data-astro-cid-j7pv25f6>a</span>ders <span style="font-weight: 300;" data-astro-cid-j7pv25f6>Initiative</span></h1><h2 class="mt-4! pb-0! text-2xl! md:text-3xl! leading-9!" data-astro-cid-j7pv25f6>
...
Mais chaque équipe dysfonctionnelle l'est à sa façon.&nbsp;</q></p><p class="hero-quote hero-question text-4xl! md:text-6xl! not-italic! pt-10!" data-astro-cid-j7pv25f6><span class="question-dash" data-astro-cid-j7pv25f6>&mdash; Et </span><span class="question-word" data-astro-cid-j7pv25f6>la vôtre&nbsp;?</span></p></div></div><div class="max-w-3xl mx-auto text-center min-h-[40vh] py-12" data-astro-cid-j7pv25f6><h2 id="h2-pourquoi" data-astro-cid-j7pv25f6>
...
<strong data-astro-cid-j7pv25f6>Ces frontières invisibles freinent votre épanouissement et la dynamique collective.</strong></p><nav aria-label="Navigation principale" data-astro-cid-j7pv25f6><a href="/contact" class="mt-8 btn btn-secondary" data-astro-cid-j7pv25f6>Il est temps <strong data-astro-cid-j7pv25f6>d'agir</strong></a></nav></div><main data-astro-cid-j7pv25f6><!-- ==========================================
    ...
    =========================================== --><section id="notre-approche" aria-labelledby="h2-pourquoi" class="py-16" data-astro-cid-j7pv25f6><div class="container min-h-[30vh] py-8" data-astro-cid-j7pv25f6><h2 id="h2-fondateurs" class="text-center! mt-8" data-astro-cid-j7pv25f6><strong data-astro-cid-j7pv25f6>Deux fondateurs</strong>, une vision commune du <strong data-astro-cid-j7pv25f6>leadership basé sur l'intention</strong></h2><p class="text-center" data-astro-cid-j7pv25f6>
...
Profil complet
</a></li></ul></div><div class="values-grid order-3 md:order-2" role="list" data-astro-cid-j7pv25f6><article role="listitem" data-astro-cid-j7pv25f6><h3 class="font-semibold text-2xl pt-4" data-astro-cid-j7pv25f6>Nous aimons l'entreprise</h3><p class="text-center md:px-20 text-[.9rem]!" data-astro-cid-j7pv25f6>
...
</p></article><article role="listitem" data-astro-cid-j7pv25f6><h3 class="font-semibold text-2xl" data-astro-cid-j7pv25f6>Nous croyons en l'humain</h3><p class="text-center md:px-20 text-[.9rem]!" data-astro-cid-j7pv25f6>
...
</p><p class="text-center md:px-20 text-[.9rem]!" data-astro-cid-j7pv25f6>
...
Profil complet
    ...
    =========================================== --><section id="offre" aria-labelledby="h2-offre" class="py-16" data-astro-cid-j7pv25f6><div class="container" data-astro-cid-j7pv25f6><h2 id="h2-offre" class="text-2xl pb-0!" data-astro-cid-j7pv25f6>
...
Nous intervenons sur tout le <strong data-astro-cid-j7pv25f6>continuum de la performance collective</strong></h3><!-- Mobile : version simplifiée --><div class="block h-90 md:hidden" data-astro-cid-j7pv25f6>${renderComponent($$result2, "ContinuumGridMobile", $$ContinuumGridMobile, { "data-astro-cid-j7pv25f6": true })}</div><!-- Desktop : version complète --><div class="hidden md:block" data-astro-cid-j7pv25f6>${renderComponent($$result2, "ContinuumGrid", $$ContinuumGrid, { "data-astro-cid-j7pv25f6": true })}</div><p class="text-center mt-0" data-astro-cid-j7pv25f6>
...
${renderComponent($$result2, "Grid", $$Grid, { "textColor": "var(--color-text-primary)", "items": [
  ...
  ], "data-astro-cid-j7pv25f6": true })}<div class="py-0 md:py-12 flex flex-col items-center gap-4" data-astro-cid-j7pv25f6><h3 data-astro-cid-j7pv25f6>
Nous avons accompagné de nombreuses équipes managériales, comités de direction et
              dirigeants exigeants actifs chez&nbsp;
</h3>${renderComponent($$result2, "Carousel", $$Carousel, { "speed": "5000", "visibleItemsMobile": "1.5", "visibleItemsDesktop": "5", "images": [
  ...
  ], "data-astro-cid-j7pv25f6": true })}</div><!-- Placeholder pour les modules/offres détaillées --><div id="offre-modules" aria-label="Nos modules d'intervention" data-astro-cid-j7pv25f6><!-- Insérer ici les cards d'offres --></div></p></div>${renderComponent($$result2, "CompassLinks", $$CompassLinks, { "data-astro-cid-j7pv25f6": true })}</section><!-- ==========================================
