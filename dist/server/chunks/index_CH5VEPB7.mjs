import { c as createComponent } from './astro-component_JoMFdLdQ.mjs';
import 'piccolore';
import { m as maybeRenderHead, e as addAttribute, d as renderTemplate, u as unescapeHTML, c as renderComponent } from './server_B5l9GFtZ.mjs';
import { r as renderScript, $ as $$Layout } from './Layout_BpVoRQBP.mjs';
import 'clsx';
...
const $$IntentionCircle = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="intention-circle" data-astro-cid-3khpc3sn> <h3 data-astro-cid-3khpc3sn>
Transformer les <strong data-astro-cid-3khpc3sn>intentions en actions</strong> concrètes, pour des équipes agissant avec <strong data-astro-cid-3khpc3sn>sens, clarté et impact</strong>.
</h3> </div>`;
}, "/Users/bluecells/Websites/all-leaders/src/components/UI/IntentionCircle.astro", void 0);
...
${renderComponent($$result2, "Grid", $$Grid, { "textColor": "var(--color-text-primary)", "items": [
  ...
  ], "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "IntentionCircle", $$IntentionCircle, { "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "CompassLinks", $$CompassLinks, { "data-astro-cid-j7pv25f6": true })} <!-- Placeholder pour les modules/offres détaillées --> <div id="offre-modules" aria-label="Nos modules d'intervention" data-astro-cid-j7pv25f6> <!-- Insérer ici les cards d'offres --> </div> </div> </section> <!-- ==========================================
