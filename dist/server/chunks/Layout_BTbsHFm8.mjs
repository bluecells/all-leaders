...
import 'piccolore';
import { w as createRenderInstruction, d as renderTemplate, u as unescapeHTML, e as addAttribute, c as renderComponent, F as Fragment, m as maybeRenderHead, f as renderSlot } from './server_eCKIsiba.mjs';
import 'clsx';
import { S as SITE, g as getCollection } from './_astro_content_B-YsshI_.mjs';
...
-->${!isHomepage && renderTemplate`${maybeRenderHead()}<nav aria-label="Fil d'Ariane" class="breadcrumb-nav" data-astro-cid-qaanghzh><ol class="breadcrumb-list" data-astro-cid-qaanghzh>${breadcrumbItems.map((item, index) => {
