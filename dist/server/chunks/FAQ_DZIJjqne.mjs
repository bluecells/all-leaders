...
import 'piccolore';
import { m as maybeRenderHead, e as addAttribute, c as renderComponent, F as Fragment, d as renderTemplate, u as unescapeHTML } from './server_eCKIsiba.mjs';
...
const $$FAQ = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div${addAttribute(fullBleed ? "w-full flex flex-col items-center" : "max-w-4xl mx-auto", "class")} data-astro-cid-al2ca2vr> ${sortedCategories.map((category) => renderTemplate`<div class="md:w-200 mb-8 md:mb-12" data-astro-cid-al2ca2vr> <h2 class="text-2xl md:text-4xl text-limolo-green mb-6 pb-2 border-b-2 border-limolo-green" data-astro-cid-al2ca2vr> ${getCategoryName(category)} </h2> <div class="space-y-4" data-astro-cid-al2ca2vr> ${faqsByCategory[category].map((faq) => renderTemplate`<details class="group border border-gray-200 rounded-lg p-3 md:p-4 hover:shadow-md transition-shadow cursor-pointer" data-astro-cid-al2ca2vr> <summary class="flex justify-between items-start font-semibold text-gray-900 group-open:text-limolo-green cursor-pointer list-none" data-astro-cid-al2ca2vr> <span class="flex-1 text-left pr-4" data-astro-cid-al2ca2vr>${faq.data.question}</span> <span class="text-limolo-green flex-shrink-0 transition-transform group-open:rotate-180" data-astro-cid-al2ca2vr>
▼
