...
import 'piccolore';
import { m as maybeRenderHead, e as addAttribute, d as renderTemplate, u as unescapeHTML, c as renderComponent } from './server_3E62P-_e.mjs';
import { r as renderScript, $ as $$Layout } from './Layout_C1zrGFLu.mjs';
import 'clsx';
...
const $$CompassLinks = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="compass-main" data-astro-cid-denskwaw> <h3 class="text-center! pt-8" data-astro-cid-denskwaw>
...
Conseil en <strong data-astro-cid-j7pv25f6>performance collective</strong>&nbsp;: du diagnostic à la transformation
...
Nous accompagnons les équipes managériales, comités de direction et dirigeants pour dépasser les
          blocages collectifs et développer un leadership basé sur l'intention.
${renderComponent($$result2, "Grid", $$Grid, { "textColor": "var(--color-text-primary)", "items": [
  ...
  ], "data-astro-cid-j7pv25f6": true })} </p><div class="h-[80vh] flex flex-col items-center justify-center" data-astro-cid-j7pv25f6> <h3 data-astro-cid-j7pv25f6>Nous avons accompagné de nombreuses équipes managériales, comités de direction et dirigeants exigeants actifs chez&nbsp;</h3> ${renderComponent($$result2, "Carousel", $$Carousel, { "speed": "5000", "images": [
  ...
  ], "data-astro-cid-j7pv25f6": true })} </div> ${renderComponent($$result2, "CompassLinks", $$CompassLinks, { "data-astro-cid-j7pv25f6": true })} <!-- Placeholder pour les modules/offres détaillées --> <div id="offre-modules" aria-label="Nos modules d'intervention" data-astro-cid-j7pv25f6> <!-- Insérer ici les cards d'offres --> </div> </div> </section> <!-- ==========================================
...
Parce qu'on ne peut parler de relations sans parler de conflits, d'agressivité voire
                  de violence, nous avons intégré à notre expertise la gestion professionnelle des conflits avec notre partenaire <b data-astro-cid-j7pv25f6>Jérôme Bouteiller</b>.
