...
import 'piccolore';
import { m as maybeRenderHead, e as addAttribute, d as renderTemplate, u as unescapeHTML, c as renderComponent } from './server_Br50Anae.mjs';
import { r as renderScript, $ as $$Layout } from './Layout_BcHa0mSL.mjs';
import 'clsx';
...
const $$ContinuumGridMobile = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="continuum-mobile-outer" data-astro-cid-b5jyzz7c> <div class="continuum-mobile-wrapper" role="img" aria-label="Continuum de la performance collective" data-astro-cid-b5jyzz7c> <div class="continuum-mobile-grid" data-astro-cid-b5jyzz7c> <div class="mobile-zone zone-blue" data-astro-cid-b5jyzz7c> <span data-astro-cid-b5jyzz7c>Collectif hautement performant</span> </div> <div class="mobile-zone zone-3" data-astro-cid-b5jyzz7c> <span data-astro-cid-b5jyzz7c>Déployer le leadership à tout niveau</span> </div> <div class="mobile-zone zone-2" data-astro-cid-b5jyzz7c> <span data-astro-cid-b5jyzz7c>Amplifier les points forts et réguler les vulnérabilités</span> </div> <div class="mobile-zone zone-1" data-astro-cid-b5jyzz7c> <span data-astro-cid-b5jyzz7c>Bien-être mental fondamental à récréer</span> </div> <div class="mobile-zone zone-red" data-astro-cid-b5jyzz7c> <span data-astro-cid-b5jyzz7c>Groupe dysfonctionnel</span> </div> </div> </div> </div> ${renderScript($$result, "/Users/bluecells/Websites/all-leaders/src/components/UI/ContinuumGridMobile.astro?astro&type=script&index=0&lang.ts")}`;
...
const $$CompassLinks = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="compass-main" data-astro-cid-denskwaw> <h3 class="text-center! w-full mx-auto max-w-4xl! px-4 py-12 md:px-0 md:pb-2 md:pt-6" data-astro-cid-denskwaw>
...
Vous sentez qu'il serait possible de <strong data-astro-cid-j7pv25f6>mieux collaborer</strong>, de retrouver du <strong data-astro-cid-j7pv25f6>sens</strong>, 
        de <strong data-astro-cid-j7pv25f6>fluidifier les relations</strong>… mais quelque chose bloque. Des habitudes
        ancrées, des non-dits, un manque de clarté.
<strong data-astro-cid-j7pv25f6>Ces frontières invisibles freinent votre épanouissement et la dynamique collective.</strong> </p> <nav aria-label="Navigation principale" data-astro-cid-j7pv25f6> <a href="/contact" class="mt-4 btn btn-secondary" data-astro-cid-j7pv25f6>Il est temps de <strong data-astro-cid-j7pv25f6>les dépasser</strong></a> </nav> </div> </div> <main data-astro-cid-j7pv25f6> <!-- ==========================================
         SECTION 1 — Pourquoi All Leaders Initiative
    =========================================== --> <section id="notre-approche" aria-labelledby="h2-pourquoi" data-astro-cid-j7pv25f6> <div class="container" data-astro-cid-j7pv25f6> <h2 id="h2-fondateurs" class="text-center! mt-8" data-astro-cid-j7pv25f6>
Nous avons créé <strong data-astro-cid-j7pv25f6>All Leaders Initiative...</strong> </h2> <p class="text-center" data-astro-cid-j7pv25f6>
...pour vous permettre de questionner ce qui ne
          fonctionne plus, oser de nouvelles façons d'agir et <strong data-astro-cid-j7pv25f6>vous affranchir de ces barrières
          invisibles.</strong> Pour réussir, <strong data-astro-cid-j7pv25f6>ensemble</strong>.
</p> </div> <div id="fondateurs" class="container min-h-0 md:py-12" data-astro-cid-j7pv25f6> <div class="values-section" data-astro-cid-j7pv25f6>  <div class="values-image-left hidden order-2 md:order-1 md:flex" data-astro-cid-j7pv25f6> <img src="/images/pages/marie-emmanuelle-py-acquarelle.webp" alt="Marie-Emmanuelle Py" class="w-full h-auto object-cover" data-astro-cid-j7pv25f6> <h3 itemprop="name" data-astro-cid-j7pv25f6>Marie Emmanuelle PY</h3> <p class="mb-4" itemprop="jobTitle" data-astro-cid-j7pv25f6>Associée fondatrice</p> <ul class="contact-list" data-astro-cid-j7pv25f6> <li data-astro-cid-j7pv25f6> <a href="mailto:me@all-leaders.fr" itemprop="email" aria-label="Envoyer un email à Marie Emmanuelle Py" data-astro-cid-j7pv25f6>
me@all-leaders.fr
...
Profil complet
</a> </li> </ul> </div> <div class="values-grid md:bg-linear-to-br md:from-slate-200/20 md:to-slate-400/10 order-1 md:order-2" role="list" data-astro-cid-j7pv25f6> <article role="listitem" data-astro-cid-j7pv25f6> <h3 class="pt-8" data-astro-cid-j7pv25f6>Nous aimons l'entreprise</h3> <p class="text-center text-[.9rem]!" data-astro-cid-j7pv25f6>
...
${renderComponent($$result2, "Grid", $$Grid, { "textColor": "var(--color-text-primary)", "items": [
  ...
  ], "data-astro-cid-j7pv25f6": true })} </p><div class="py-0 md:py-12 flex flex-col items-center gap-4" data-astro-cid-j7pv25f6> <h3 data-astro-cid-j7pv25f6>
Nous avons accompagné de nombreuses équipes managériales, comités de direction et
    ...
    { image: "/images/pages/ocp.png", alt: "OCP" },
  ...
  ], "data-astro-cid-j7pv25f6": true })} </div> <!-- Placeholder pour les modules/offres détaillées --> <div id="offre-modules" aria-label="Nos modules d'intervention" data-astro-cid-j7pv25f6> <!-- Insérer ici les cards d'offres --> </div>  </div> ${renderComponent($$result2, "CompassLinks", $$CompassLinks, { "data-astro-cid-j7pv25f6": true })} </section> <!-- ==========================================
