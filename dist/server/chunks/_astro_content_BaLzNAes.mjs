...
import { x as renderElement, y as generateCspDigest, s as spreadAttributes, u as unescapeHTML, d as renderTemplate, z as removeBase, i as isRemotePath, A as AstroError, B as UnknownContentCollectionError, C as RenderUndefinedEntryError, D as prependForwardSlash, G as createHeadAndContent, c as renderComponent } from './server_CzbfgBPT.mjs';
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_virtual_astro_get-image_DPkkMZ8K.mjs');
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_BzEo-O76.mjs');
