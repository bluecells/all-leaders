...
import 'piccolore';
import { m as maybeRenderHead, e as addAttribute, d as renderTemplate, u as unescapeHTML, c as renderComponent } from './server_eCKIsiba.mjs';
import { r as renderScript, $ as $$Layout } from './Layout_BTbsHFm8.mjs';
import 'clsx';
...
const $$CompassLinks = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="compass-main" data-astro-cid-denskwaw> <div class="bg-white/80 my-10 p-4 shadow-2xl md:shadow-none rounded-md z-50 w-10/12 mx-auto" data-astro-cid-denskwaw> <h3 class="text-center! w-full mx-auto max-w-4xl! md:pb-2 md:pt-0" data-astro-cid-denskwaw>
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$props, $$slots);
  Astro2.self = $$Index;
  return renderTemplate`${renderScript($$result, "/Users/bluecells/Websites/all-leaders/src/pages/index.astro?astro&type=script&index=0&lang.ts")} ${renderComponent($$result, "Layout", $$Layout, { "title": "All Leaders Initiative — Leadership basé sur l'intention pour dirigeants et équipes managériales", "lang": "fr", "metaTitle": "All Leaders Initiative — Conseil en Leadership et Performance Collective", "metaDescription": "All Leaders Initiative accompagne les équipes managériales, comités de direction et dirigeants pour dépasser les blocages collectifs et développer un leadership basé sur l'intention.", "data-astro-cid-j7pv25f6": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="mx-auto hero-section halos-confines" data-astro-cid-j7pv25f6> <!-- Hero Title - Animé après --> <div class="hero-title" data-astro-cid-j7pv25f6> <h1 class="mb-0! py-2! text-xl! font-base md:text-3xl! 2xl:text-[60px]! leading-8 md:leading-10 2xl:leading-tight!" style="opacity: 0;" data-astro-cid-j7pv25f6> <q data-astro-cid-j7pv25f6>&nbsp;Toutes les équipes performantes se ressemblent.<br data-astro-cid-j7pv25f6>
Mais chaque équipe dysfonctionnelle l'est à sa façon.&nbsp;</q> </h1> <h2 class="hero-quote hero-question text-3xl! md:text-4xl! 2xl:text-[60px]! not-italic! mt-6!" data-astro-cid-j7pv25f6> <span class="question-dash" data-astro-cid-j7pv25f6>&mdash; Et </span><span class="question-word" data-astro-cid-j7pv25f6>la vôtre&nbsp;?</span> </h2> </div> </div> <div class="mx-auto flex flex-col items-center justify-center py-10 md:p-25" data-astro-cid-j7pv25f6> <!-- Hero Quote - Centre au début, puis slide vers le bas --> <div class="hero-quote-wrapper" data-astro-cid-j7pv25f6> <p class="mx-auto" data-astro-cid-j7pv25f6>
Vous sentez qu'il serait possible de <strong data-astro-cid-j7pv25f6>mieux collaborer</strong>, de retrouver du <strong data-astro-cid-j7pv25f6>sens</strong>, de <strong data-astro-cid-j7pv25f6>fluidifier les relations</strong>… mais quelque chose bloque. Des habitudes
        ancrées, des non-dits, un manque de clarté.<br data-astro-cid-j7pv25f6> </p> <p class="mx-auto py-10 text-2xl!" data-astro-cid-j7pv25f6> <strong data-astro-cid-j7pv25f6>Ces frontières invisibles<br data-astro-cid-j7pv25f6>freinent votre épanouissement<br data-astro-cid-j7pv25f6>et la dynamique
          collective.</strong> </p> <nav aria-label="Navigation principale" data-astro-cid-j7pv25f6> <a href="/accompagnements" class="mt-4 btn btn-secondary" data-astro-cid-j7pv25f6>Il est temps de <strong data-astro-cid-j7pv25f6>les dépasser</strong></a> </nav> </div> </div> <main data-astro-cid-j7pv25f6> <!-- ==========================================
...
pour vous permettre de questionner ce qui ne fonctionne plus, oser de nouvelles façons
            d'agir et <strong data-astro-cid-j7pv25f6>vous affranchir de ces barrières invisibles.</strong> <br data-astro-cid-j7pv25f6>Pour réussir, <strong data-astro-cid-j7pv25f6>ensemble</strong>.
...
Nous y avons grandi et en avons tiré beaucoup de fierté. Nous savons qu'elle doit
              offrir un <b data-astro-cid-j7pv25f6>cadre</b> qui favorise la <b data-astro-cid-j7pv25f6>responsabilité</b>, la <b data-astro-cid-j7pv25f6>solidarité</b> et <b data-astro-cid-j7pv25f6>l'initiative</b>.
...
Grâce à la <b data-astro-cid-j7pv25f6>sécurité psychologique</b> et à l'affirmation de son <b data-astro-cid-j7pv25f6>intention</b>,
              chacun peut devenir <b data-astro-cid-j7pv25f6>leader</b> et choisir consciemment d'influencer positivement son
              environnement.
...
Nos parcours de marins, dans la sécurité nucléaire et une grande diversité de cultures
              managériales nous ont appris à voir les organisations comme des <b data-astro-cid-j7pv25f6>équipages&nbsp;</b>: des collectifs qui gagnent en cultivant <b data-astro-cid-j7pv25f6>courage</b>, <b data-astro-cid-j7pv25f6>cohésion</b>, <b data-astro-cid-j7pv25f6>alignement</b> et <b data-astro-cid-j7pv25f6>sens</b>.
</p><p class="text-center text-[.9rem]!" data-astro-cid-j7pv25f6>
C'est dans cet esprit que nous vous accompagnons, avec la discipline des marins et
                l'audace des aventuriers.
...
Profil complet
</a> </li> </ul> </div> </div> </section> </main>  <section id="offre" aria-labelledby="h2-offre" class="pt-16" data-astro-cid-j7pv25f6> <div class="container h-full" data-astro-cid-j7pv25f6> <h2 class="mb-0 mt-0 texte-gradient" data-astro-cid-j7pv25f6>
Coaching de performance collective&nbsp;: nous intervenons sur tout le <strong data-astro-cid-j7pv25f6>continuum de la performance collective</strong> </h2> <!-- Mobile : version simplifiée --> <div class="mobile-continuum-section md:hidden" data-astro-cid-j7pv25f6> ${renderComponent($$result2, "ContinuumGridMobile", $$ContinuumGridMobile, { "data-astro-cid-j7pv25f6": true })} </div> <!-- Desktop : version complète --> <div class="hidden md:block" data-astro-cid-j7pv25f6> ${renderComponent($$result2, "ContinuumGrid", $$ContinuumGrid, { "data-astro-cid-j7pv25f6": true })} </div> ${renderComponent($$result2, "Grid", $$Grid, { "textColor": "var(--color-text-primary)", "reverse": "true", "items": [
    {
      title: "Bien-être mental<br>fondamental à récréer",
  ...
  ], "data-astro-cid-j7pv25f6": true })} </div> </section> <section data-astro-cid-j7pv25f6> <div class="py-0 px-4 md:py-12 flex flex-col items-center gap-4" data-astro-cid-j7pv25f6> <p class="my-0 text-2xl! text-center" data-astro-cid-j7pv25f6>
Nous avons accompagné de nombreuses <b data-astro-cid-j7pv25f6>équipes managériales, comités de direction et dirigeants</b>
exigeants actifs chez&nbsp;
  ...
  ], "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "BannerReviews", $$BannerReviews, { "data-astro-cid-j7pv25f6": true })} </div> ${renderComponent($$result2, "CompassLinks", $$CompassLinks, { "data-astro-cid-j7pv25f6": true })} </section>  <section id="ecosysteme" aria-labelledby="h2-ecosysteme" class="py-0 md:py-16" data-astro-cid-j7pv25f6> <div class="container mx-auto" data-astro-cid-j7pv25f6> <h2 id="h2-ecosysteme" class="text-center! mt-8" data-astro-cid-j7pv25f6>
Découvrez ceux qui naviguent avec nous et incarnent <strong data-astro-cid-j7pv25f6>le leadership</strong> que nous développons.
...
Parce qu'on ne peut parler de relations sans parler de conflits, d'agressivité voire
                de violence, nous avons intégré à notre expertise la gestion professionnelle des
                conflits avec notre partenaire <b data-astro-cid-j7pv25f6>Jérôme Bouteiller</b>.
...
</p> <a href="https://www.fa3r.fr/" aria-label="En savoir plus sur FA3R" data-astro-cid-j7pv25f6>Apprendre sous stress, décider sous pression, tenir ensemble.</a> </div> </article> </li> </ul> </div> </section> ` })}`;
