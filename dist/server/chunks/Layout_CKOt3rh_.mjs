...
import 'piccolore';
import { w as createRenderInstruction, d as renderTemplate, u as unescapeHTML, e as addAttribute, c as renderComponent, F as Fragment, m as maybeRenderHead, f as renderSlot } from './server_DEsIIqeN.mjs';
import 'clsx';
import { S as SITE, g as getCollection } from './_astro_content_CGEfEMwd.mjs';
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<footer class="footer-main" data-astro-cid-sz7xmlte> <div class="footer-container" data-astro-cid-sz7xmlte> <div class="footer-grid" data-astro-cid-sz7xmlte> <!-- Section 1: Logo & Adresse --> <div class="footer-section" data-astro-cid-sz7xmlte> <img src="/images/pages/logo-all-leaders-rond-fonce.svg" alt="Logo" class="footer-logo-brand" data-astro-cid-sz7xmlte> <h3 class="footer-title" data-astro-cid-sz7xmlte>${t.company}</h3> <p class="footer-address" data-astro-cid-sz7xmlte> ${t.address},<br data-astro-cid-sz7xmlte> ${t.city} </p> </div> <!-- Section 2: Explorer & Pilote --> <div class="footer-section" data-astro-cid-sz7xmlte> <div class="footer-explorer" data-astro-cid-sz7xmlte> <div class="pilotine" data-astro-cid-sz7xmlte></div> <div class="menu-explorer" data-astro-cid-sz7xmlte> <ol class="footer-links" data-astro-cid-sz7xmlte> <li data-astro-cid-sz7xmlte><a href="https://bureaudureel.fr" class="footer-link" data-astro-cid-sz7xmlte>${t.bureauDuReel}</a></li> <li data-astro-cid-sz7xmlte><a${addAttribute(navigationLinks.blog, "href")} class="footer-link" data-astro-cid-sz7xmlte>${t.blog}</a></li> <li data-astro-cid-sz7xmlte><a${addAttribute(navigationLinks.faq, "href")} class="footer-link" data-astro-cid-sz7xmlte>${t.faq}</a></li> <li data-astro-cid-sz7xmlte><a${addAttribute(navigationLinks.privacy, "href")} class="footer-link" data-astro-cid-sz7xmlte>${t.privacy}</a></li> <li data-astro-cid-sz7xmlte><a${addAttribute(navigationLinks.cookie, "href")} class="footer-link" data-astro-cid-sz7xmlte>${t.cookie}</a></li> </ol> </div> </div> </div> <!-- Section 3: Newsletter --> <div class="footer-section" data-astro-cid-sz7xmlte> <img src="/images/pages/bateau.webp" alt="Bateau" class="footer-logo-ship" data-astro-cid-sz7xmlte> <h4 class="footer-heading mb-0!" data-astro-cid-sz7xmlte>${t.keepInTouch}</h4> <p class="leading-snug! mb-0" data-astro-cid-sz7xmlte> ${t.newsletterText} </p> <a href="https://bureaudureel.kessel.media/" target="_blank" class="btn-limolo" data-astro-cid-sz7xmlte> <span class="btn-subtitle" data-astro-cid-sz7xmlte>${t.subscribe}</span><br data-astro-cid-sz7xmlte> <span class="btn-title" data-astro-cid-sz7xmlte>${t.newsletterTitle}</span> </a> </div> </div> <!-- Bottom: Social & Copyright --> <div class="footer-bottom" data-astro-cid-sz7xmlte> <div class="footer-social" data-astro-cid-sz7xmlte> <a href="https://www.instagram.com/bureaudureel/" class="social-link" data-astro-cid-sz7xmlte>${t.instagram}</a> <a href="https://www.youtube.com/@bureaudureel" class="social-link" data-astro-cid-sz7xmlte>${t.youtube}</a> <a href="https://www.linkedin.com/company/all-leaders-initiative/" class="social-link" data-astro-cid-sz7xmlte>${t.linkedin}</a> <a href="mailto:contact@all-leaders.fr" class="social-link email-link" data-astro-cid-sz7xmlte>contact@all-leaders.fr</a> </div> <div class="footer-copyright" data-astro-cid-sz7xmlte>
...
const $$Breadcrumb = createComponent(($$result, $$props, $$slots) => {
  ...
  if (items.length > 0) {
    ...
    if (isRessources && pathSegments.length >= 3) {
      const resourcesLabel = isEnglish ? "Resources" : "Ressources";
      const categoryFromPath = pathSegments[isEnglish ? 2 : 1];
      ...
      const resourcesBaseUrl = isEnglish ? "/en/resources" : "/ressources";
