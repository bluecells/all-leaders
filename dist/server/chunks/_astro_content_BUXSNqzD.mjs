...
import { j as renderElement, k as generateCspDigest, s as spreadAttributes, u as unescapeHTML, d as renderTemplate, l as removeBase, i as isRemotePath, A as AstroError, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, p as prependForwardSlash, n as createHeadAndContent, c as renderComponent } from './server__edj_reH.mjs';
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_virtual_astro_get-image_BBvzVs-K.mjs');
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_BnXui5_d.mjs');
