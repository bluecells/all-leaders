...
import 'piccolore';
import { m as maybeRenderHead, e as addAttribute, d as renderTemplate, u as unescapeHTML, c as renderComponent } from './server_01FeskOi.mjs';
import { r as renderScript, $ as $$Layout } from './Layout_D3A-g322.mjs';
import 'clsx';
...
const $$ContinuumGridMobile = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="continuum-mobile-outer" data-astro-cid-b5jyzz7c> <div class="continuum-mobile-wrapper" role="img" aria-label="Continuum de la performance collective" data-astro-cid-b5jyzz7c> <div class="continuum-mobile-grid" data-astro-cid-b5jyzz7c> <div class="mobile-zone zone-blue" data-astro-cid-b5jyzz7c> <span data-astro-cid-b5jyzz7c>Collectif hautement performant</span> </div> <div class="mobile-zone zone-3" data-astro-cid-b5jyzz7c> <img class="img-bouees" src="/images/pages/bouee-eaux-saines.webp" alt="" data-astro-cid-b5jyzz7c> <span data-astro-cid-b5jyzz7c>Déployer le leadership<br data-astro-cid-b5jyzz7c>à tout niveau</span> </div> <div class="mobile-zone zone-2" data-astro-cid-b5jyzz7c> <img class="img-bouees" src="/images/pages/balise-speciale.webp" alt="" data-astro-cid-b5jyzz7c> <span data-astro-cid-b5jyzz7c>Amplifier les points forts et réguler les vulnérabilités</span> </div> <div class="mobile-zone zone-1" data-astro-cid-b5jyzz7c> <img class="img-bouees" src="/images/pages/marque-de-danger-isole.webp" alt="" data-astro-cid-b5jyzz7c> <span data-astro-cid-b5jyzz7c>Bien-être mental<br data-astro-cid-b5jyzz7c>fondamental à récréer</span> </div> <div class="mobile-zone zone-red" data-astro-cid-b5jyzz7c> <span data-astro-cid-b5jyzz7c>Groupe dysfonctionnel</span> </div> </div> </div> </div> ${renderScript($$result, "/Users/bluecells/Websites/all-leaders/src/components/UI/ContinuumGridMobile.astro?astro&type=script&index=0&lang.ts")}`;
...
Nous avons créé <span class="brand-text" data-astro-cid-j7pv25f6>
ALL <span class="leaders" data-astro-cid-j7pv25f6>LE<span class="stylized-a" data-astro-cid-j7pv25f6>A</span>DERS</span> <span class="thin" data-astro-cid-j7pv25f6>INITIATIVE</span> </span>...
...
...pour vous permettre de questionner ce qui ne fonctionne plus, oser de nouvelles façons
          d'agir et <strong data-astro-cid-j7pv25f6>vous affranchir de ces barrières invisibles.</strong> Pour réussir, <strong data-astro-cid-j7pv25f6>ensemble</strong>.
...
Coaching de performance collective&nbsp;: nous intervenons sur tout le <strong data-astro-cid-j7pv25f6>continuum de la performance collective</strong> </h2> <!-- Mobile : version simplifiée --> <div class="mobile-continuum-section md:hidden" data-astro-cid-j7pv25f6> ${renderComponent($$result2, "ContinuumGridMobile", $$ContinuumGridMobile, { "data-astro-cid-j7pv25f6": true })} </div> <!-- Desktop : version complète --> <div class="hidden md:block" data-astro-cid-j7pv25f6> ${renderComponent($$result2, "ContinuumGrid", $$ContinuumGrid, { "data-astro-cid-j7pv25f6": true })} </div> ${renderComponent($$result2, "Grid", $$Grid, { "textColor": "var(--color-text-primary)", "items": [
  ...
  ], "data-astro-cid-j7pv25f6": true })} <p class="text-center mt-4" data-astro-cid-j7pv25f6>
...
Nous avons accompagné de nombreuses équipes managériales, comités de direction et
  ...
  ], "data-astro-cid-j7pv25f6": true })} </div> <!-- Placeholder pour les modules/offres détaillées --> <div id="offre-modules" aria-label="Nos modules d'intervention" data-astro-cid-j7pv25f6> <!-- Insérer ici les cards d'offres --> </div> </div> </section> ${renderComponent($$result2, "CompassLinks", $$CompassLinks, { "data-astro-cid-j7pv25f6": true })} <!-- ==========================================
...
ALL <span class="leaders" data-astro-cid-j7pv25f6>LEADERS</span> <span class="thin" data-astro-cid-j7pv25f6>INITIATIVE</span> </span> est partie prenante du Bureau du Réel, un réseau d'intervenants pour des formats
                  de conférences disruptifs et centrés sur l'expérience vécue.
