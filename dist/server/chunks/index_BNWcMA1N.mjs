...
import 'piccolore';
import { m as maybeRenderHead, e as addAttribute, d as renderTemplate, u as unescapeHTML, c as renderComponent } from './server_DLCPDVwv.mjs';
import { r as renderScript, $ as $$Layout } from './Layout_B3Z9WxEI.mjs';
import 'clsx';
...
</p> <a href="#" aria-label="En savoir plus sur FA3R" data-astro-cid-j7pv25f6>En savoir plus</a> </div> </article> </li> </ul> </div> </section> <!-- ==========================================
         SECTION 4 — Fondateurs
    =========================================== --> <section id="fondateurs" aria-labelledby="h2-fondateurs" data-astro-cid-j7pv25f6> <div class="container" data-astro-cid-j7pv25f6> <h2 id="h2-fondateurs" data-astro-cid-j7pv25f6>
Deux fondateurs, une vision commune du leadership basé sur l'intention
</h2> <p data-astro-cid-j7pv25f6>
...
Profil LinkedIn
</a> </li> </ul> </article> </div> </div> </section> <!-- ==========================================
         SECTION 5 — CTA Final / Contact
    =========================================== --> <section id="contact" aria-labelledby="h2-contact" data-astro-cid-j7pv25f6> <div class="container" data-astro-cid-j7pv25f6> <h2 id="h2-contact" data-astro-cid-j7pv25f6>Prêt à transformer la dynamique de votre équipe&nbsp;?</h2> <p data-astro-cid-j7pv25f6>
Engagez la conversation avec nos fondateurs et explorons ensemble comment
          All Leaders Initiative peut vous accompagner.
</p> <nav aria-label="Actions de contact" data-astro-cid-j7pv25f6> <a href="mailto:me@all-leaders.fr" class="btn btn-primary" data-astro-cid-j7pv25f6>Contacter Marie Emmanuelle</a> <a href="mailto:pe@all-leaders.fr" class="btn btn-primary" data-astro-cid-j7pv25f6>Contacter Pierre-Etienne</a> </nav> </div> </section> </main> ` })}`;
