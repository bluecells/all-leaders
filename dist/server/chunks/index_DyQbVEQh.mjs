...
Mais chaque équipe dysfonctionnelle l'est à sa façon.&nbsp;</q> </h1> <h2 class="hero-quote hero-question text-3xl! md:text-4xl! 2xl:text-[60px]! not-italic! mt-2!" data-astro-cid-j7pv25f6> <span class="question-dash" data-astro-cid-j7pv25f6>&mdash; Et </span><span class="question-word" data-astro-cid-j7pv25f6>la vôtre&nbsp;?</span> </h2> </div> </div> <div class="mx-auto flex flex-col items-center justify-center py-10 md:p-25" data-astro-cid-j7pv25f6> <!-- Hero Quote - Centre au début, puis slide vers le bas --> <div class="hero-quote-wrapper" data-astro-cid-j7pv25f6> <p class="mx-auto" data-astro-cid-j7pv25f6>
