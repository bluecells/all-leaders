...
import 'piccolore';
import { m as maybeRenderHead, e as addAttribute, d as renderTemplate, c as renderComponent } from './server_01FeskOi.mjs';
import { $ as $$Layout } from './Layout_D3A-g322.mjs';
import 'clsx';
import { g as getCollection } from './_astro_content_CJljDULs.mjs';
...
const $$Accompagnements = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Les accompagnements de All Leaders Initiative", "metaTitle": "Nos accompagnements - All Leaders Initiative", "metaDescription": "Développez la performance collective de vos équipes et de leurs leaders ! Coaching, diagnostic LBI et santé mentale : nous transformons vos blocages en leviers d'action.", "lang": "fr", "data-astro-cid-j4cwuawe": true }, { "default": async ($$result2) => renderTemplate(_a || (_a = __template([" ", `<div class="flex flex-col justify-center align-items mx-auto min-h-[83vh]" data-astro-cid-j4cwuawe> <h1 class="mb-8 text-3xl md:text-6xl text-center" data-astro-cid-j4cwuawe>Nos accompagnements</h1> <h2 data-astro-cid-j4cwuawe>Solutions de diagnostic et développement pour vos organisations</h2> <!-- Navigation des catégories d'accompagnements --> <nav class="categories-nav" data-astro-cid-j4cwuawe> <div class="categories-nav-wrapper" data-astro-cid-j4cwuawe> `, ` </div> <div class="arrow-container" data-astro-cid-j4cwuawe> <svg width="100" height="50" viewBox="0 0 100 50" xmlns="http://www.w3.org/2000/svg" data-astro-cid-j4cwuawe> <path d="M0 50L50 0L100 50Z" fill="#182433" data-astro-cid-j4cwuawe></path> </svg> <div class="arrow-colours" data-astro-cid-j4cwuawe></div> </div> </nav> </div>  <section class="modalites-section" data-astro-cid-j4cwuawe> <h2 class="text-2xl! md:text-4xl font-bold pt-4! md:pt-10!" data-astro-cid-j4cwuawe>4 modalités d'intervention</h2> <div class="modalites-container" data-astro-cid-j4cwuawe> `, " </div> </section>  ", ` <script>
