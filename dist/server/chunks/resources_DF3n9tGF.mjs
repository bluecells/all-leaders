...
ALL <span class="leaders" data-astro-cid-bkcv3667>LEADERS</span> <span class="thin" data-astro-cid-bkcv3667>INITIATIVE</span> </span> </h2> <!-- Blog Component --> ${renderComponent($$result2, "BlogSection", $$Blog, { "lang": "en", "fullBleed": true, "data-astro-cid-bkcv3667": true })} </div> ${renderComponent($$result2, "ActionBar", $$ActionBar, { "data-astro-cid-bkcv3667": true })} ` })}`;
