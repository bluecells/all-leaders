...
import 'piccolore';
import { c as renderComponent, d as renderTemplate, m as maybeRenderHead, e as addAttribute, f as renderSlot } from './server_DEsIIqeN.mjs';
import { b as getEntry, r as renderEntry, g as getCollection } from './_astro_content_CGEfEMwd.mjs';
import { $ as $$Layout, a as $$Breadcrumb } from './Layout_CKOt3rh_.mjs';
...
const $$LayoutBlog = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": title, "metaTitle": metaTitle, "metaDescription": metaDescription || excerpt || "", "ogImage": ogImage || featuredImagePath, "ogType": "article", "publishDate": new Date(publishDate), "lang": lang, "jsonType": "blog", "alternateUrls": alternateUrls, "data-astro-cid-m337sa5b": true }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<article class="bg-[#fdfdfd] min-h-screen pb-10" data-astro-cid-m337sa5b> <header class="relative pb-16 md:py-8" data-astro-cid-m337sa5b> <div class="max-w-4xl mx-auto px-6 text-center" data-astro-cid-m337sa5b> <div class="inline-block px-4 pt-1 pb-2 rounded-lg bg-limolo-green/5 border border-limolo-green/10 mb-8" data-astro-cid-m337sa5b> <span class="text-[10px] uppercase tracking-[0.3em]  font-bold text-limolo-green" data-astro-cid-m337sa5b> ${categoryLabel} </span> </div> <h1 class="text-3xl md:text-5xl font-serif text-limolo-green leading-[1.1] mb-8" data-astro-cid-m337sa5b> ${cleanText(displayH1)} </h1> <div class="flex items-center justify-center gap-4 text-gray-400" data-astro-cid-m337sa5b> <span class="h-px w-8 bg-gray-200" data-astro-cid-m337sa5b></span> <time class="text-[11px] uppercase tracking-widest font-bold" data-astro-cid-m337sa5b> ${formatDate(publishDate, lang)} </time> <span class="h-px w-8 bg-gray-200" data-astro-cid-m337sa5b></span> </div> ${excerpt && renderTemplate`<p class="py-4 text-xl md:text-2xl text-gray-600 font-serif italic leading-relaxed max-w-3xl mx-auto" data-astro-cid-m337sa5b>
"${cleanText(excerpt)}"
</p>`} </div> </header> ${featuredImagePath && renderTemplate`<div class="w-full max-w-2xl mx-auto px-4 mb-16" data-astro-cid-m337sa5b> <div class="relative aspect-21/9 rounded-xl overflow-hidden shadow-2xl shadow-limolo-green/10" data-astro-cid-m337sa5b> <img${addAttribute(featuredImagePath, "src")}${addAttribute(featuredImageAlt || title, "alt")} class="w-full h-full object-cover" data-astro-cid-m337sa5b> </div> </div>`} <div class="prose-content max-w-4xl mx-auto" data-astro-cid-m337sa5b> ${renderSlot($$result2, $$slots["default"])} </div> ${related && related.length > 0 && renderTemplate`<section class="bg-gray-50 border-t border-gray-100 mt-24 py-24" data-astro-cid-m337sa5b> <div class="max-w-7xl mx-auto px-6" data-astro-cid-m337sa5b> <h2 class="text-3xl font-serif text-limolo-green text-center mb-16" data-astro-cid-m337sa5b> ${getRelatedTitle(lang)} </h2> <div class="grid grid-cols-1 md:grid-cols-3 gap-10" data-astro-cid-m337sa5b> ${await Promise.all(
    related.map(async (item) => {
      ...
      return renderTemplate`<a${addAttribute(url, "href")} class="group block" data-astro-cid-m337sa5b> <div class="aspect-16/10 rounded-2xl overflow-hidden mb-6 shadow-sm" data-astro-cid-m337sa5b> <img${addAttribute(itemFeaturedImagePath, "src")}${addAttribute(itemFeaturedImageAlt || item.data.title, "alt")} class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" data-astro-cid-m337sa5b> </div> <div class="text-[10px] uppercase tracking-widest font-bold text-limolo-green mb-3" data-astro-cid-m337sa5b> ${itemCategoryLabel} </div> <h3 class="text-lg font-serif text-gray-800 leading-snug group-hover:text-limolo-accent transition-colors" data-astro-cid-m337sa5b> ${cleanText(item.data.title)} </h3> </a>`;
    })
  )} </div> </div> </section>`} <h3 data-astro-cid-m337sa5b>
Pour en savoir plus... <br data-astro-cid-m337sa5b><br data-astro-cid-m337sa5b><a class="btn-limolo" href="/contact/" data-astro-cid-m337sa5b>Contactez-nous</a> </h3> </article> ` })}`;
...
const $$ = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const [articles, accompagnements, faq, landingPages] = await Promise.all([
