...
import 'piccolore';
import { w as createRenderInstruction, d as renderTemplate, u as unescapeHTML, e as addAttribute, c as renderComponent, F as Fragment, m as maybeRenderHead, f as renderSlot } from './server_Du_7o2g7.mjs';
import 'clsx';
import { S as SITE, g as getCollection } from './_astro_content_C_UNwJv_.mjs';
...
const $$Breadcrumb = createComponent(($$result, $$props, $$slots) => {
  ...
  function slugToLabel(slug) {
    const smallWords = /* @__PURE__ */ new Set(["de", "la", "le", "et", "ou", "à", "un", "une", "en", "au", "aux", "sur", "sous", "pour", "par", "du", "les"]);
  ...
  if (items.length > 0) {
    ...
    if (isRessources && pathSegments.length >= 3) {
      ...
      const categoryLabel = category || slugToLabel(categoryFromPath);
      const titleFromPath = pathSegments[pathSegments.length - 1];
      const titleLabel = title || slugToLabel(titleFromPath);
