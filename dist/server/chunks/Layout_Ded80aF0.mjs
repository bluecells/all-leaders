...
import 'piccolore';
import { h as createRenderInstruction, d as renderTemplate, u as unescapeHTML, e as addAttribute, c as renderComponent, F as Fragment, m as maybeRenderHead, g as renderSlot } from './server_D2WlyLFw.mjs';
import 'clsx';
import { S as SITE, g as getCollection } from './_astro_content_DMBpWl0a.mjs';
...
const links$1 = [{"label":"Nos accompagnements","url":"/services","type":"link","hasSubmenu":false,"submenu":[]},{"label":"Ressources","url":"/ressources","type":"link","hasSubmenu":false,"submenu":[]},{"label":"Contact","url":"/contact","type":"link","hasSubmenu":false,"submenu":[]}];
const menuFR = {
  links: links$1,
};

const links = [{"label":"Our Services","url":"/en/services","type":"link","hasSubmenu":false,"submenu":[]},{"label":"Resources","url":"/en/resources","type":"link","hasSubmenu":false,"submenu":[]},{"label":"Contact","url":"/en/contact","type":"link","hasSubmenu":false,"submenu":[]}];
const menuEN = {
  links,
};
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  ...
  const localizedSlugs = {
    fr: {
      blog: "ressources",
      faq: "faq-all-leaders-french",
      privacy: "privacy-policy-fr",
      cookie: "cookies-policy-fr"
    },
    en: {
      blog: "resources",
      faq: "faq-all-leaders-english",
  ...
  return renderTemplate`${maybeRenderHead()}<footer class="footer-main" data-astro-cid-sz7xmlte> <div class="footer-container" data-astro-cid-sz7xmlte> <div class="footer-grid" data-astro-cid-sz7xmlte> <div class="footer-section" data-astro-cid-sz7xmlte> <h3 class="footer-title" data-astro-cid-sz7xmlte>${t.company}</h3> <p class="footer-address" data-astro-cid-sz7xmlte> ${t.address},<br data-astro-cid-sz7xmlte> ${t.city} </p> <p class="footer-address" data-astro-cid-sz7xmlte> ${t.vat}<br data-astro-cid-sz7xmlte> ${t.siret}<br data-astro-cid-sz7xmlte> </p> <div class="footer-contact" data-astro-cid-sz7xmlte> <a href="tel:+393924812458" class="contact-link" data-astro-cid-sz7xmlte>+39 392 48 12 458</a> <a href="mailto:contact@all-leaders.fr" class="contact-link" data-astro-cid-sz7xmlte>contact@all-leaders.fr</a> <a href="https://wa.me/393924812458/" class="contact-link" data-astro-cid-sz7xmlte>${t.whatsapp}</a> </div> </div> <div class="footer-section" data-astro-cid-sz7xmlte> <h4 class="footer-heading" data-astro-cid-sz7xmlte>${t.explore}</h4> <ol class="footer-links" data-astro-cid-sz7xmlte> <li data-astro-cid-sz7xmlte><a href="https://bureaudureel.fr" class="footer-link" data-astro-cid-sz7xmlte>${t.bureauDuReel}</a></li> <li data-astro-cid-sz7xmlte><a${addAttribute(navigationLinks.blog, "href")} class="footer-link" data-astro-cid-sz7xmlte>${t.blog}</a></li> <li data-astro-cid-sz7xmlte><a${addAttribute(navigationLinks.faq, "href")} class="footer-link" data-astro-cid-sz7xmlte>${t.faq}</a></li> <li data-astro-cid-sz7xmlte><a${addAttribute(navigationLinks.privacy, "href")} class="footer-link" data-astro-cid-sz7xmlte>${t.privacy}</a></li> <li data-astro-cid-sz7xmlte><a${addAttribute(navigationLinks.cookie, "href")} class="footer-link" data-astro-cid-sz7xmlte>${t.cookie}</a></li> </ol> </div> <div class="footer-section" data-astro-cid-sz7xmlte> <h4 class="footer-heading" data-astro-cid-sz7xmlte>${t.keepInTouch}</h4> <p class="newsletter-text" data-astro-cid-sz7xmlte> ${t.newsletterText} </p> <a href="https://limolohouse56green.substack.com/subscribe" target="_blank" class="btn-limolo" style="display:inline-block; width: auto;" data-astro-cid-sz7xmlte>${t.subscribe}<br data-astro-cid-sz7xmlte> <span class="font-bold text-lg" data-astro-cid-sz7xmlte>${t.newsletter56Green}</span> </a> </div> </div> <div class="footer-bottom" data-astro-cid-sz7xmlte> <div class="footer-social" data-astro-cid-sz7xmlte> <a href="https://www.instagram.com/limolo.house/" class="social-link" data-astro-cid-sz7xmlte>${t.instagram}</a> <a href="https://www.facebook.com/Limolo.house/" class="social-link" data-astro-cid-sz7xmlte>${t.facebook}</a> <a href="https://www.linkedin.com/company/limolo-house/" class="social-link" data-astro-cid-sz7xmlte>${t.linkedin}</a> </div> <p class="footer-copyright" data-astro-cid-sz7xmlte>
