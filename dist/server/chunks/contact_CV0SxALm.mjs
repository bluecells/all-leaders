...
import 'piccolore';
import { m as maybeRenderHead, f as renderSlot, d as renderTemplate, c as renderComponent, e as addAttribute } from './server_3E62P-_e.mjs';
import { $ as $$Layout } from './Layout_C1zrGFLu.mjs';
import 'clsx';
import { C as CONTACT } from './_astro_content_oe3tNoc4.mjs';
...
<\/script>`], ["", ` <script>
  ...
  document.addEventListener("astro:after-swap", init)
  init()
<\/script>`])), renderComponent($$result, "Layout", $$Layout, { "title": CONTACT.TITLE, "metaTitle": CONTACT.METATITLE, "metaDescription": CONTACT.METADESCRIPTION, "data-astro-cid-uw5kdbxl": true }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Container", $$Container, { "data-astro-cid-uw5kdbxl": true }, { "default": async ($$result3) => renderTemplate` ${maybeRenderHead()}<div class="contact-container" data-astro-cid-uw5kdbxl> <div class="contact-header" data-astro-cid-uw5kdbxl> <h1 class="contact-title" data-astro-cid-uw5kdbxl>
Parlons de vos <span class="contact-accent" data-astro-cid-uw5kdbxl>objectifs de performance collective</span>.
</h1> <p class="contact-subtitle" data-astro-cid-uw5kdbxl>
Une question sur un accompagnement ou une idée de projet&nbsp;? Notre équipe vous répond avec précision.
