...
import 'piccolore';
import { h as createRenderInstruction, d as renderTemplate, u as unescapeHTML, e as addAttribute, c as renderComponent, F as Fragment, m as maybeRenderHead, g as renderSlot } from './server_GXSVGQot.mjs';
import 'clsx';
import { S as SITE, a as getEntry, g as getCollection } from './_astro_content_BLyoDwpZ.mjs';
...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const menuData = await getEntry("menu", lang);
  const liensDuMenu = menuData?.data.links || [];
