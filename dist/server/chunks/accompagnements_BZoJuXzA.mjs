...
import 'piccolore';
import { m as maybeRenderHead, e as addAttribute, d as renderTemplate, c as renderComponent } from './server_DEsIIqeN.mjs';
import { $ as $$Layout } from './Layout_CKOt3rh_.mjs';
import 'clsx';
import { g as getCollection } from './_astro_content_CGEfEMwd.mjs';
...
const $$Accompagnements = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Accompagnements - All Leaders", "metaTitle": "Nos accompagnements - All Leaders Initiative", "metaDescription": "Découvrez nos accompagnements en diagnostic de performance, formation, coaching et conseil.", "lang": "fr", "data-astro-cid-j4cwuawe": true }, { "default": async ($$result2) => renderTemplate(_a || (_a = __template([" ", `<div class="flex flex-col justify-center align-items mx-auto min-h-[83vh]" data-astro-cid-j4cwuawe> <h1 class="mb-8 text-4xl md:text-6xl text-center" data-astro-cid-j4cwuawe>Nos accompagnements</h1> <h2 data-astro-cid-j4cwuawe>Solutions de diagnostic et développement pour vos organisations</h2> <!-- Navigation des catégories d'accompagnements --> <nav class="categories-nav" data-astro-cid-j4cwuawe> <div class="categories-nav-wrapper" data-astro-cid-j4cwuawe> `, ' </div> <div class="arrow-container" data-astro-cid-j4cwuawe> <svg width="100" height="50" viewBox="0 0 100 50" xmlns="http://www.w3.org/2000/svg" data-astro-cid-j4cwuawe> <path d="M0 50L50 0L100 50Z" fill="#182433" data-astro-cid-j4cwuawe></path> </svg> <div class="arrow-colours" data-astro-cid-j4cwuawe></div> </div> </nav> </div>  ', `  <section class="modalites-section" data-astro-cid-j4cwuawe> <h2 class="text-4xl! font-bold pt-10!" data-astro-cid-j4cwuawe>4 modalités d'intervention</h2> <div class="modalites-container" data-astro-cid-j4cwuawe> `, ` </div> </section> <script>
    ...
    function initAnimation() {
      ...
      if (navLinks.length > 0) {
        ...
        tl.from(navLinks, {
          opacity: 0,
          duration: 1.2, // 0.6s * 3 = 1.8s
          stagger: {
            each: 0.1, // 0.15s * 3 = 0.45s entre chaque lien
  ...
  <\/script> `])), maybeRenderHead(), sortedCategories.map((cat) => renderTemplate`<a${addAttribute(`#category-${cat.data.slug_fr}`, "href")}${addAttribute(`category-nav-link category-nav-link-${cat.data.order}`, "class")} data-astro-cid-j4cwuawe> ${cat.data.name_fr} </a>`), renderComponent($$result2, "AccompagnementsGrid", $$AccompagnementsGrid, { "lang": "fr", "fullBleed": true, "data-astro-cid-j4cwuawe": true }), sortedModalites.map((modalite) => {
    const objectiveMap = {
