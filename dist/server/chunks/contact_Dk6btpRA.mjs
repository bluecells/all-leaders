...
import 'piccolore';
import { d as renderTemplate, c as renderComponent, m as maybeRenderHead, e as addAttribute } from './server_Du_7o2g7.mjs';
import { $ as $$Layout } from './Layout_DggAW1u-.mjs';
import { $ as $$Container } from './Container_BfoASFo7.mjs';
import { C as CONTACT } from './_astro_content_C_UNwJv_.mjs';
...
<\/script>`], ["", ` <script>
  ...
  document.addEventListener('astro:after-swap', init);
  init();
<\/script>`])), renderComponent($$result, "Layout", $$Layout, { "title": CONTACT.TITLE, "metaTitle": CONTACT.METATITLE, "metaDescription": CONTACT.METADESCRIPTION, "data-astro-cid-uw5kdbxl": true }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Container", $$Container, { "data-astro-cid-uw5kdbxl": true }, { "default": async ($$result3) => renderTemplate` ${maybeRenderHead()}<div class="contact-container min-h-[80vh]" data-astro-cid-uw5kdbxl> <div class="contact-header" data-astro-cid-uw5kdbxl> <h1 class="contact-title pt-8! pb-0!" data-astro-cid-uw5kdbxl>Contactez-nous</h1> <p class="contact-subtitle pb-0" data-astro-cid-uw5kdbxl>
Et si nous parlions de performance collective&nbsp;?<br data-astro-cid-uw5kdbxl> Notre équipe vous répond avec
          précision.
