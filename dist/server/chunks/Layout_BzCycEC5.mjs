...
import 'piccolore';
import { w as createRenderInstruction, d as renderTemplate, u as unescapeHTML, e as addAttribute, c as renderComponent, F as Fragment, m as maybeRenderHead, f as renderSlot } from './server_9mu4lEgk.mjs';
import 'clsx';
import { S as SITE, g as getCollection } from './_astro_content_xUKIXKKi.mjs';
...
const links = [{"label":"Our Services","url":"/en/services","type":"link","hasSubmenu":false,"submenu":[]},{"label":"FAQ","url":"/en/faq","type":"link","hasSubmenu":false,"submenu":[]},{"label":"Contact","url":"/en/contact","type":"link","hasSubmenu":false,"submenu":[]}];
const menuEN = {
  links,
};
