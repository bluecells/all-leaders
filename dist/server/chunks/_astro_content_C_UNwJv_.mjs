...
import { x as renderElement, y as generateCspDigest, s as spreadAttributes, u as unescapeHTML, d as renderTemplate, z as removeBase, i as isRemotePath, A as AstroError, B as UnknownContentCollectionError, C as RenderUndefinedEntryError, D as prependForwardSlash, G as createHeadAndContent, c as renderComponent } from './server_Du_7o2g7.mjs';
...
const PRIVACY = {
  ...
  METADESCRIPTION: "Découvrez notre politique de confidentialité"
};
const COOKIES = {
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DdzhcTf9.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_virtual_astro_get-image_DqcXQvX1.mjs');
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_Cfifn4g2.mjs');
...
export { CONTACT as C, PRIVACY as P, SITE as S, COOKIES as a, getEntry as b, renderUniqueStylesheet as c, renderScriptElement as d, getCollection as g, renderEntry as r };
