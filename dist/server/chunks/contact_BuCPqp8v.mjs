...
import 'piccolore';
import { d as renderTemplate, c as renderComponent, m as maybeRenderHead, e as addAttribute } from './server_Dx_l8faJ.mjs';
import { $ as $$Layout } from './Layout_D4fzmtad.mjs';
import { $ as $$Container } from './Container_DijSbShU.mjs';
import { C as CONTACT } from './_astro_content_B295nimE.mjs';
...
<\/script>`], ["", ` <script>
  ...
  document.addEventListener('astro:after-swap', init);
  init();
<\/script>`])), renderComponent($$result, "Layout", $$Layout, { "title": CONTACT.TITLE, "metaTitle": CONTACT.METATITLE, "metaDescription": CONTACT.METADESCRIPTION, "data-astro-cid-uw5kdbxl": true }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Container", $$Container, { "data-astro-cid-uw5kdbxl": true }, { "default": async ($$result3) => renderTemplate` ${maybeRenderHead()}<div class="contact-container min-h-[90vh]" data-astro-cid-uw5kdbxl> <div class="contact-layout" data-astro-cid-uw5kdbxl> <div class="contact-left" data-astro-cid-uw5kdbxl> <img class="ali-logo-watercolour" src="images/pages/logo-ali-aquarelle.webp" alt="Logo All Leaders Initiative" data-astro-cid-uw5kdbxl> <h1 class="contact-title" data-astro-cid-uw5kdbxl>Contactez-nous</h1> <p class="contact-subtitle md:pb-20" data-astro-cid-uw5kdbxl>
