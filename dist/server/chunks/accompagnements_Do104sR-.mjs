...
import 'piccolore';
import { m as maybeRenderHead, e as addAttribute, d as renderTemplate, c as renderComponent } from './server__edj_reH.mjs';
import { $ as $$Layout } from './Layout_D4dKH1zz.mjs';
import 'clsx';
import { g as getCollection } from './_astro_content_BUXSNqzD.mjs';
...
const $$Accompagnements = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Accompagnements - All Leaders", "metaTitle": "Nos accompagnements - All Leaders Initiative", "metaDescription": "Découvrez nos accompagnements en diagnostic de performance, formation, coaching et conseil.", "lang": "fr", "data-astro-cid-j4cwuawe": true }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="flex flex-col justify-center align-items mx-auto px-4 min-h-[85vh]" data-astro-cid-j4cwuawe> <h1 class="font-serif text-limolo-green mb-8 text-center" data-astro-cid-j4cwuawe>Nos accompagnements</h1> <h2 data-astro-cid-j4cwuawe>Solutions de diagnostic et développement pour vos organisations</h2> <!-- Conteneur pour l'ordre mobile inversé --> <div class="accompaniments-wrapper" data-astro-cid-j4cwuawe> <!-- AccompagnementsGrid Component avec cards cliquables --> ${renderComponent($$result2, "AccompagnementsGrid", $$AccompagnementsGrid, { "lang": "fr", "fullBleed": true, "data-astro-cid-j4cwuawe": true })} <!-- Navigation des catégories d'accompagnements avec flèche --> <nav class="categories-nav" data-astro-cid-j4cwuawe> <div class="categories-nav-wrapper" data-astro-cid-j4cwuawe> ${sortedCategories.map((cat) => renderTemplate`<a${addAttribute(`#category-${cat.data.slug}`, "href")}${addAttribute(`category-nav-link category-nav-link-${cat.data.order}`, "class")} data-astro-cid-j4cwuawe> ${cat.data.name_fr} </a>`)} </div> <!-- Flèche collée à la nav --> <div class="arrow-container" data-astro-cid-j4cwuawe> <svg class="arrow-progression" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" data-astro-cid-j4cwuawe> <path d="M5 12h14M12 5l7 7-7 7" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" data-astro-cid-j4cwuawe></path> </svg> </div> </nav> </div> </div>  <section class="modalites-section" data-astro-cid-j4cwuawe> <div class="modalites-container" data-astro-cid-j4cwuawe> ${sortedModalites.map((modalite) => {
    const objectiveMap = {
