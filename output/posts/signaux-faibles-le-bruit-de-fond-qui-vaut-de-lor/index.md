...
### **_L’inspiration des services de renseignement français_.**
...
### **_Asymétrie de la parole et du silence_**
...
### **_Comment faire émerger le potentiel de l’information ?_**
...
### _Dans votre expérience, quand vous disposez de milliers d’informations, quelle est l’attitude à privilégier pour faire émerger des données pertinentes du bruit de fond ?_
...
### _Savez-vous ce que vous cherchez ou pas forcément ?_
...
### _Alors que faire des données brutes ? Des signaux faibles et de tout ce « bruit de fond » que vous avez récolté ?_
...
#### **Pour mettre les données en relation et leur donner un sens, le principe est d’identifier ce que l’on craint, c'est-à-dire la menace**.

Cette menace est différente en fonction de votre type d’industrie. Par exemple, la menace pour une banque est le vol des données de ses clients ou détecter des transferts frauduleux. La menace pour une entreprise pharmaceutique sera plutôt le vol de la formule du prochain vaccin contre le Covid… À ce moment, il est nécessaire non seulement de mettre en place des barrières physiques entre le public et les personnes qui ont accès à la formule, mais ça ne suffit pas.

Le travail consistera également à enregistrer un maximum de données sur l’environnement de travail. Ces données seules ne veulent pas dire grand-chose. Vous pouvez vous connecter à deux heures du matin. Vous avez le droit de travailler sur un fichier sensible si vous faites partie de l’équipe de développement. Ou encore, vous pouvez éventuellement le copier sur une clé USB si vous devez travailler dessus à partir d’un autre poste. Mais si vous copiez le fichier sur une clé USB à deux heures du matin, cela doit alerter. C’est le principe des corrélations.
...
### _Et lorsqu’on ne sait pas exactement ce que l’on craint ? Comment imaginer l’imprévisible ?_
...
### Culture de sûreté et fort esprit d'équipage
...
### Quelques points facilement applicables à l'entreprise
...
_Marie Emmanuelle Py & Olivier Fichot_
